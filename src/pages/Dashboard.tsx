    ...
    <DashboardLayout>
      <div className="max-w-6xl animate-fade-in-up">
        <div className="mb-8 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">
            Welcome to PortIQ
          </h1>
          ...
          <p className="text-gray-400 text-base sm:text-lg">Select a feature from the sidebar to get started</p>
        </div>
          ...
          {[
            ...
            return (
              <div
                ...
                className="group bg-gradient-to-br from-gray-900 to-black p-6 sm:p-8 rounded-2xl border border-gray-800 hover:border-gray-600 transition-all duration-500 cursor-pointer relative overflow-hidden transform hover:scale-105 hover:-translate-y-2 animate-fade-in-up"

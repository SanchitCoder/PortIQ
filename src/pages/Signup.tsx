      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        <div className="text-center mb-6 sm:mb-8">
          <div className="flex flex-col items-center gap-4 sm:gap-6 mb-6 sm:mb-8">
            ...
            <p className="text-gray-400 text-base sm:text-lg">Start making smarter investment decisions</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-center text-gray-400 mt-6 relative z-10">
              ...
              <Link to="/login" className="text-white hover:underline relative group/link transition-all duration-300">
